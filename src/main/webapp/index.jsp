		...
		<div class="gtco-container">
			...
			<div class="row">
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="resources/images/img_2.jpg" class="fh5co-project-item image-popup">
						<figure>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="resources/images/img_3.jpg" class="fh5co-project-item image-popup">
						<figure>
							<div class="overlay"><i class="ti-plus"></i></div>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="resources/images/img_4.jpg" class="fh5co-project-item image-popup">
						<figure>
							<div class="overlay"><i class="ti-plus"></i></div>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="resources/images/img_1.jpg" class="fh5co-project-item image-popup">
						<figure>
							<div class="overlay"><i class="ti-plus"></i></div>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="resources/images/img_5.jpg" class="fh5co-project-item image-popup">
						<figure>
							<div class="overlay"><i class="ti-plus"></i></div>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="resources/images/img_6.jpg" class="fh5co-project-item image-popup">
						<figure>
							<div class="overlay"><i class="ti-plus"></i></div>
